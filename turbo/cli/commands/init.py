...
"""
        ...
        try:
            ...
            console.print(f"[green]✓[/green] Workspace initialized successfully at {workspace_path}")
            console.print(f"  Configuration: {turbo_dir / 'config.toml'}")
            console.print(f"  Database initialized")
        except Exception as e:
            console.print(f"[yellow]Workspace created but database initialization failed: {e}[/yellow]")
