...
class TestExportCommand:
    ...
    def test_export_all_data(self, mock_doc_service, mock_issue_service, mock_project_service):
...
class TestSearchCommand:
    ...
    def test_search_all(self, mock_doc_service, mock_issue_service, mock_project_service):
