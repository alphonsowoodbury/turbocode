...
class TestProjectCLI:
    ...
    def test_create_project_success(self, mock_get_service):
        ...
        result = self.runner.invoke(projects_group, [
            'create',
            '--name', 'Test Project',
    ...
    def test_get_project_not_found(self, mock_get_service):
        ...
        mock_service = AsyncMock()
        mock_service.get_project_by_id.side_effect = ProjectNotFoundError(self.sample_project_id)
        mock_get_service.return_value = mock_service
...
class TestProjectCLIValidation:
    ...
    def test_completion_percentage_validation(self):
        ...
        result = self.runner.invoke(projects_group, [
            'update',
            str(uuid4()),
            '--completion', '150'  # Invalid percentage > 100
        ])
